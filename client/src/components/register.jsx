...
const Register = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "dob") {
      ...
      if (inputDate > today) {
        // Display an error message or handle the error as per your UI/UX requirement
        // For now, I'm setting an empty string to clear the DOB field
        setUser((prevUser) => ({
          ...prevUser,
          [name]: "",
        }));
    ...
    // If the DOB is valid, proceed with updating the state
    setUser((prevUser) => ({
      ...prevUser,
      [name]: value,
    }));
